...
function positionElements() {
  // Positioning buttons dynamically based on the current window size
  leftbutton.position(windowWidth * 0.05, windowHeight * 0.2);
  button.position(windowWidth * 0.1, windowHeight * 0.2);
  rightbutton.position(windowWidth * 0.2, windowHeight * 0.2);
  
  keywordsearch.position(windowWidth * 0.05, windowHeight * 0.8);
  search.position(windowWidth * 0.25, windowHeight * 0.8);

  valslider.position(windowWidth * 0.05, windowHeight * 0.5);
  energyslider.position(windowWidth * 0.05, windowHeight * 0.55);
}
